...
const em = orm.em;
function sanitizeAlquilerInput(req, res, next) {
...
async function getAll(req, res) {
    try {
        ...
        let alquileres;
        if (req.isAdmin) {
            alquileres = await em.find(Alquiler, {
                $and: [
            ...
            alquileres = await em.find(Alquiler, { usuario }, {
                populate: [
                    "usuario",
                    "vehiculo",
                    "vehiculo.sucursal",
...
async function findOne(req, res) {
    try {
        ...
        const alquilerBuscado = await em.findOneOrFail(Alquiler, { id }, {
            populate: [
                "usuario",
                "vehiculo",
                "vehiculo.sucursal",
...
async function updateStatus(req, res) {
    try {
        const id = Number.parseInt(req.params.id);
        const alquiler = await em.findOne(Alquiler, { id }, { populate: ["usuario"] });
        if (!alquiler) {
...
//# sourceMappingURL=alquiler.controler.js.map