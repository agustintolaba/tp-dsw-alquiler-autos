...
async function findAll(req, res) {
    try {
        const vehiculos = await em.find(Vehiculo, {}, { populate: ["tipoVehiculo", "sucursal"] });
        res
            .status(200)
...
async function availables(req, res) {
    try {
        const { fecha_desde, fecha_hasta, transmision, tipo_vehiculo, sucursal } = req.query;
...
export { sanitizeVehiculoInput, findAll, findOne, add, update, remove, availables, search, };
